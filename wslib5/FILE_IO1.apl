#!/usr/local/bin/apl --script --
 ...
 ⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝
⍝
⍝ FILE_IO1.apl 2014-07-29 15:40:42 (GMT+2)
⍝
⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝⍝
...
∇txt←FIO∆pipefrom cmd;ph;Ze;txt
...
⍝⍝ Br: handles ready for reading
 ⍝⍝
⍝⍝ (Zc Zr Zw Ze Zt)←Z is a (nested) 5-item vector:
...
⍝⍝ happen).
 ⍝⍝
 Z←⎕FIO.fork_daemon Bs
∇

∇Z ← Af FIO∆sprintf Bs
⍝⍝ sprintf( Af, B1...) format Af and data B1, ...
 Z←Af ⎕FIO.fork_daemon Bs
∇
...
⍝ now obsoleted by ⎕FIO understanding e.g. ⎕FIO['errno'] and even ⎕FIO.errno, but
