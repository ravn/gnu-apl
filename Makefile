...
LDFLAGS = 
LIBOBJS = 
LIBS = -lpcre2-32 -lX11-xcb -lX11 -lxcb -lfftw3 -ldl -lpthread -lm -lncurses -lnsl 
...
POSTGRESQL_VERSION = 9.3.24
RANLIB = ranlib
RATIONAL_NUMBERS_WANTED = no
...
SUBDIRS = $(APL_DIRS) build doc erlang gnu-apl.d HOWTOs src \
	support-files tools websock
